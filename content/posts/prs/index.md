...
### But mainly the love for the gem
...
<img src="gem2.png" width="100" alt="diamond-of-acceptance"/>

It makes me happy to see it on my PR, but it makes me happy to see it on someone else's PR too! It makes me happy to be able to give a :gem: to someone for the excellent work they have done!

Instead of just putting a label *"approved"* or *"LGTM"*, this gives the feeling of respect, the idea that "this code is a real diamond". I don't care how stupid this might sound, but I love it! ;D

---
However, this was not the only thing I wanted to write about.
I've seen a lot of different ways of working with pull requests, and imo some are terrible and some are good.
...
This usually lead into one person to go through the code, and then just someone to rubberstamp it.
...
I love it when people take time to read through others' code, and find ways to make it better, readable, and usable. It takes time. But it makes the codebase so much better, and it also increases knowledge of the code, both for the reviewer(s) and the coder.
